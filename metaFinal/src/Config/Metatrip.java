...
//    reservation_voiture rhv1=new reservation_voiture(5.5f,"cccc","jandouba",u8,v78);
 ...
 evenement e = new evenement(2, "hhhuhonl", "c", "7 rue 2938", date1, 12.0f,"image.pg") ; 
  evenement e1 = new evenement(4, "aaaaaaa", "c", "7 rue 2938", date1, 120.0f,"image.pg") ; 
  //se.ajouter(e1);
    //se.modifier(e);
  // se.supprimer(1);
...
//  
    ...
    evenement e10 = new evenement(2, "Musical", "BALTI", "7 rue 2938", date5, 450.0f,"/c/event1.png") ; 
  //see.ajouter(e10);
...
//  evenement e1 = new evenement(4, "aaaaaaa", "c", "7 rue 2938", date1, 120.0f,"c/image") ; 
//  //se.ajouter(e1);
//    //se.modifier(e);
//  // se.supprimer(1);
//  // System.out.println(se.afficher());
...
//     sponsor s = new sponsor(25, "Vitalait", 22252718, "amine@zarga.tn", date_sp, 12.0f,e,"c://zarga.png") ; 
...
try{
    ...
    launch(args);              
     ...
     Date date_sp=Date.valueOf(xx2);
     sponsor s = new sponsor(20, "VITALAIT", "22252715", "aminezarga9@gmail.com", date_sp, 12f, "zarga.pg", e10) ; 
     Servicesponsor ss = new Servicesponsor(); 
